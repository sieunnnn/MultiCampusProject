...
<summary> 
	...
	<br>
	<code><b>플래너<b></code>
	<li> 새로운 멤버 추가시 프로필 사진이 엑박으로 뜨는 현상<br>
	<li> <code>private</code> 설정 시 그룹 멤버들만 볼 수 있어야 하는데, 그룹 외 인원도 볼 수 있음<br>
	<li> 다른 아이디를 같은 브라우저를 이용하여 로그인 할 경우 사용하다 하나의 아이디로 합쳐지는 이슈<br>
<br>
...
`ETC`
- 해상도가 노트북에 맞춰져 있어서 데스크탑으로 볼 시 깨지는 현상<br>
<br>
