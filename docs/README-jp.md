...
<br>
<h3>プランナー</h3>
<li> 新しいメンバーを追加すると、プロフィール写真が正しく出力されない現象です<br>
<li> <code>private</code> 設定時、グループメンバーのみ見ることができなければなりませんが、グループ外の人も見ることができます<br>
<li> 他のIDを同じブラウザを利用してログインする場合、使用して一つのIDに統合されるイシュー<br>

<br>

<h3>Post</h3>
<li>commentボタン位置イシュー<br>

<br>

<h3>ETC</h3>
<li>解像度がノートパソコンに合わせてあるため、デスクトップで見るとサイズが合わない現象です<br>
